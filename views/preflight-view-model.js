...
export function createPreflightViewModel(preflight){
  ...
  const cards=Object.freeze([
    Object.freeze({label:'Template version',value:preflight.template.detectedVersion||'Not detected',tone:preflight.template.compatibility==='supported'?'ready':'error'}),
    ...
    Object.freeze({label:'Preflight status',value:preflight.canContinueToMapping?'Ready for mapping':'Needs attention',tone:preflight.canContinueToMapping?'ready':'error'})
  ]);
